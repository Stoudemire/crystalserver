...
enum ConfigKey_t : uint16_t {
	...
	STASH_MANAGE_AMOUNT,
	TOGGLE_RESET_SYSTEM,
	RESET_REQUIRED_LEVEL,
	RESET_DAMAGE_BONUS_PER_RESET,
	RESET_DEFENSE_BONUS_PER_RESET,
	RESET_MAX_RESETS,
	RESET_BACK_TO_LEVEL,
	TOGGLE_RESEET_HEALTH_MANA_BONUS,
	RESET_BONUS_HEALTH_PERCENT,
	RESET_BONUS_MANA_PERCENT,
	TOGGLE_RESET_RESTORE_SPEED,
};
